...
if __name__=='__main__':
    ...
    galaxy_parameters = generate_galaxy(num_stars,r_range)  # creating galaxy

    ani = animation.FuncAnimation(fig, update, 100, interval=1000/fps, fargs = (galaxy_parameters,ax,))
    print('ass')
    fn = 'gacjasasld'
